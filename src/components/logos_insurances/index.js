...
class LogosInsurances extends Component {
        ...
        return (
            <div id="footer-cars-v4">
                ...
                <div className="pull-right" style={{width: '380px'}}>
                    <img
                        src="https://segdig1.s3.amazonaws.com/static/core-app/img/sections/cars/apply/norton-verisign.jpg"
                        alt="Norton Verisign"
                        align="left" hspace="3px" style={{float: 'left'}}/>
            <span>
...
export default LogosInsurances